...
export declare const MenuBar: (props: Partial<import("../utils/createComponent.js").ThemedWebComponentProps<MenuBarElement, Readonly<{
    onItemSelected: EventName<_MenuBarEventMap["item-selected"]>;
}>>> & React.RefAttributes<MenuBarElement>) => React.ReactElement | null;
